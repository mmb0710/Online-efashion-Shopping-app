    ...
    <footer className="bg-black text-gray-400">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {/* About Section */}
          <div>
            <h2 className="text-white text-lg font-bold mb-6">About Tirra</h2>
            <p className="text-gray-400 leading-relaxed">
            Tirra is your go-to store for the latest trends and fashion, all
        ...
        <div className="border-t border-gray-800">
          ...
          <div className="py-8 text-center">
            <p className="font-semibold text-gray-400 mb-2 tracking-wide">
              © 2024 Tirra. All rights reserved.
            </p>
